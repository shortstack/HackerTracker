...
public class DetailsView extends FrameLayout {
    ...
    public DetailsView(Context context, Default item, GenericDefaultRenderer genericDefaultRenderer) {
        super(context);
        init();
        this.item = item;
        display();
...
//    }
    ...
    private void updateBookmark() {
        bookmark.setImageDrawable(getResources().getDrawable( item.isBookmarked() ? R.drawable.ic_bookmark_white_24dp : R.drawable.ic_bookmark_border_white_24dp));
    }
}
