...
public class SkytalksPagerFragment extends Fragment {

    static ViewPager pager;
    private Context context;
    private static final String ARG_SECTION_NUMBER = "section_number";

    public static SkytalksPagerFragment newInstance(int position) {
        SkytalksPagerFragment frag=new SkytalksPagerFragment();
    ...
    private PagerAdapter buildAdapter() {
        return(new SkytalksPagerAdapter(getActivity(), getChildFragmentManager()));
    }
